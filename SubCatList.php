...
include $tpl ."header.php";
                                                    $sql ="select subcategory.* ,category.CategoryName
                                                    from myshop.subcategory, myshop.category where subcategory.parentID =CategoryID ";
...
<div class="form-add SubCategory-List">
                <div class="sec-title" style="display: flex;align-items: center;justify-content: space-between;">
                    ...
                    <a href="AddSubCate.php" class="btn btn-primary" style="width: 200px !important;">Add new Sub Category</a>
                                ...
                                <tbody>
                                                    <?php 
                                                            ...
                                                            "<tr> 
                                                                ...
                                                                <td>".$subcat['SubCatCode']."</td>
                                                                <td>".$subcat['Description']."</td>
                                                                <td>admin</td>
                                                                <td>".$subcat['TimeAdd']."</td>
                                                                <td class='actions'>
                                                                <a title='Edit Proudact' href='UpdateUser.php?id=".$subcat['SubCateID']."' class='action'><i class='fa-regular fa-pen-to-square'></i></a>
                                                                <a title='Remove Proudact' href='SubCatList.php?id=".$subcat['SubCateID']."' class='action'><i class='fa-regular fa-trash-can'></i></a>
                                                            </td>
                                                            </tr>";                                        
                                                                }
                                                               ?>
