...
$Avater=$_POST['Avater'];
    ...
    $sql = "select * from myshop.supplier where email=:email";
    ...
    if ($stm2->rowCount() > 0) {
        ...
        title: 'Error!',
        text: 'The Email already exists, use another Email ',
        icon: 'error',
        confirmButtonText: 'OK'
      })</script>";
    } 
    else{
    $stmt= $con->prepare("insert into myshop.supplier (SupplierName,email,Country,State,phone,Description,Avater) VALUES 
    (:SupplierName,:email,:Country,:State,:phone,:Description,:Avater)");
    ...
    $stmt ->execute();
        ...
        Swal.fire(
        'Good job!',
        'Add Supplier completed successfully',
        'success'
                    )
    </script>";
}
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- phone  number -->
    <link rel="stylesheet" href="/OurProject/admin/layout/phone-number-with-country-code/build/css/intlTelInput.css">
...
<body>
    <div class="dashboard">
        ...
        <div class="content">
            ...
            <!-- new Supplier  -->
            <div class="form-add new-Supplier">
                <div class="sec-title">
                    <h2 class="main-title">Supplier Management</h2>
                    <p class="desc-title">Add/Update Supplier</p>
                </div>
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="SupplierName" id="" class="form-control " required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="image-upload">
                                            <input type="file" name="Avater" id="uplodeimg" class="form-control"  required>
