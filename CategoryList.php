                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                                            ...
                                                            "<tr> 
                                                                ...
                                                                <td>".$cat['TimeAdd']."</td>
                                                                <td class='actions'>
                                                                <a title='Edit Category' href='UpdateUser.php?id=".$cat['CategoryID']."' class='action'><i class='fa-regular fa-pen-to-square'></i></a>
                                                                <a title='Remove Category' href='CategoryList.php?id=".$cat['CategoryID']."' class='action'><i class='fa-regular fa-trash-can'></i></a>
                                                            </td>
                                                            </tr>";                                        
                                                                }
                                                            ?>
