    ...
    <div class="navbar">
        <div class="container">
            ...
            <ul class="icons">
                ...
                <li><a href="#" class="user" id="accountSettings" onclick="shoowDropDown()"><i
                            ...
                            <tbody>
                                <?php foreach($wishitem as $item){?>
                                        <?php
                                            ...
                                            ?>
                                <tr>
                                    <td><a href="Wishlist.php?ItemID=<?php echo $item['ItemID']; ?>"><i class="fa-solid fa-xmark icon"></i></a></td>
                                    <td><img src="layout/imges/proudact/<?php echo $item['img']?>" alt="" width="50"></td>
                                    <td><?php echo $item['itemname'] ?></td>
                                    <td><?php echo $item['price'] ;?> $</td>
                                    <td><?php echo $status ?></td>
                                    <td><a class="btn btn-primary" href="ProductView.php?id=<?php echo $item['ItemID']; ?>" role="button">Add to cart</a></td>
                                </tr>
                                <?php } ?>
