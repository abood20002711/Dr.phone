                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Donec libero dolor, tincidunt id laoreet vitae,
                    ...
                    <div class="row">
                        <div class="col col-lg-6 col-sm-12">
                            <div class="context">
                                ...
                                <p>Donec libero dolor, tincidunt id laoreet vitae, ullamcorper eu tortor. Maecenas pellentesque, dui vitae iaculis mattis,
                                tortor nisi faucibus magna, vitae ultrices lacus purus vitae metus. Ut nec odio facilisis, ultricies nunc eget,
                                fringilla orci.</p>
                            </div>
                        </div>
                        <div class="col col-lg-6 col-sm-12">
                ...
                <div class="arro col-tow col-lg-6">
                    ...
                    <ul class="arrow">
                        <li>
                            ...
                            <i></i>
                            <h2>Support 24/7</h2>
                            <p>Vestibulum velit nibh, egestas vel faucibus vitae, feugiat sollicitudin urna. Praesent iaculis id ipsum sit amet
